                ...
                <div class="register-user">
                    ...
                    <form action="{{ route('postEditProduct') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="d-flex mb-3 gap-2 align-items-center">
                            ...
                            <input type="text" class="form-control" value="{{ $edit_product->name }}" name="name"
                                id="name">
                        </div>
                        <div class="d-flex mb-3 gap-2 align-items-center">
                            <label for="price" class="form-label">Цена</label>
                            <input type="text" class="form-control" value="{{ $edit_product->price }}" name="price"
                                id="price">
                        </div>
                        {{-- @dd($edit_product) --}}
                        <div class="d-flex mb-3 gap-2 align-items-center">
                            ...
                            <select name="category_id" class="form-select" aria-label="Категории">
                        ...
                        <div class="d-flex mb-3 gap-2 align-items-center">
                            ...
                            <input type="hidden" name="oldImage" value="{{ $edit_product->image }}">
                        </div>
                        <div class="d-flex mb-3 gap-2 align-items-center">
                            ...
                            <input type="number" min="0" pattern="\d [0-9]"
                                ...
                                value="{{ $edit_product->qty }}" name="qty" id="qty">
                        </div>
                        <input type="hidden" value="{{ $edit_product->id }}" name="id">
