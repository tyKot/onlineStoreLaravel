                ...
                <div class="register-user">
                    ...
                    <form action="{{ route('createUser') }}" method="post">
                        ...
                        <div class="d-flex mb-3 gap-2 align-items-center">
                            ...
                            <input type="text" class="form-control" name="municipality" id="md">
                        </div>
                        <div class="d-flex mb-3 gap-2 align-items-center">
                            <label for="locality" class="form-label">Населённый пункт</label>
                            <select class="form-select js-select2" name="locality" id="locality">
                                @foreach ($locality as $localityItem)
                                    <option value="{{ $localityItem->name }}">{{ $localityItem->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="d-flex mb-3 gap-2 align-items-center">
